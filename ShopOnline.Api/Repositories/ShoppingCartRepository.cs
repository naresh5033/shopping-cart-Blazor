        ...
        public async Task<CartItem> AddItem(CartItemToAddDto cartItemToAddDto)
        {
            if (await CartItemExists(cartItemToAddDto.CartId, cartItemToAddDto.ProductId) == false)
            {
                var item = await (from product in this.shopOnlineDbContext.Products
                                  where product.Id == cartItemToAddDto.ProductId //making sure that one instance of the product is added to the cart
                                  select new CartItem
                                  {
                ...
                if (item != null)
                {
                    ...
                    return result.Entity; //once the save changes to the database return the entity
                }
            } //else return null
